        ...
        <nav class="navbars">
            ...
            <div class="navbar-main py-4">
                <ul class="p-[10px] max-h-[100vh] overflow-auto m-0 navigation-ul">
                    ...
                    <li class="relative whitespace-nowrap m-0">
                        <a href="{{ route('lembur') }}" class="nav-item {{ set_active(['lembur']) }} flex items-center overflow-hidden px-4 py-[9px] my-3 text-ellipsis">
                            <i data-feather="flag" class="w-[20px]"></i><span class="ml-[15px] text-base font-medium">Lembur</span>
                        </a>
                    </li>
                    <li class="relative whitespace-nowrap m-0">
