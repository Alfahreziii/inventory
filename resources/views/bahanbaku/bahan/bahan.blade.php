...
<h1 class="font-bold text-slate-600 text-3xl">NAMA BAHAN</h1>
<div class="flex  text-sm font-normal items-center mt-1">
    ...
    <a href="#" class="text-slate-400">Nama Bahan</a>
</div>

{{-- Task --}}
<div class="garis mt-10 mb-3">
    <div class="bg-slate-100 pr-3 text-lg font-medium text-slate-600">NAMA BAHAN</div>
</div>

@can('admin-access')
<a href="{{ route('buat-namabahan') }}" class="ml-auto shadow flex mb-5 mt-3 justify-center items-center text-sm py-3 font-semibold rounded text-white bg-green-500">
